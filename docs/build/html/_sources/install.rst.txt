...
.. Note::
    ...
    2. [0.9] Currently, supporting python versions are updated to linux: 3.8/3.9/3.10; MacOS-osx64 3.7+ (no conda support). You can change python=* argument to the version you want.  

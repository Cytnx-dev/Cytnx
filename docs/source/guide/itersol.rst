...
This approach is more versatile than using the standard sparse storage format. Linear algebra algorithms can be implemented matrix-free with a LinOp object that defines how an input tensor is transformed, for example by contracting it in a more complicated network.

...
extlinks = {'splo':("https://docs.scipy.org/doc/scipy/reference/generated/scipy.sparse.linalg.LinearOperator.html%s",None),\
            ...
            'numpy-slice':("https://numpy.org/doc/stable/reference/arrays.indexing.html%s",None),\
            'numpy-vstack':("https://numpy.org/doc/stable/reference/generated/numpy.vstack.html%s",None),\
            'cuda-mem':("https://docs.nvidia.com/cuda/cuda-runtime-api/group__CUDART__MEMORY.html%s",None),\
            'lanczos-er':("https://www.sciencedirect.com/science/article/pii/S0010465597001367%s",None),\
            'anaconda':("https://repo.anaconda.com/archive/%s",None),\
            'miniconda':("https://repo.anaconda.com/miniconda/%s",None),\
            ...
            'cytnx_latest_api':("../api/index.html%s",None),\
            'cytnx_namespace':("../api/namespacecytnx.html%s",None),\
            'cytnx_linalg':("../api/namespacecytnx_1_1linalg.html%s",None)\
            }

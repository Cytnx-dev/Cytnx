...
\DoxyCodeLine{56 \textcolor{comment}{}    \textcolor{keyword}{explicit} \mbox{\hyperlink{classcytnx_1_1Accessor_a9f6fa9087f09756e020355a05196d384}{Accessor}}(\textcolor{keyword}{const} cytnx\_int64 \&loc);}
...
\DoxyCodeLine{77     \textcolor{keyword}{explicit} Accessor(\textcolor{keyword}{const} std::string \&str);}
\DoxyCodeLine{78 }
\DoxyCodeLine{79     \textcolor{comment}{// range constr.}}
\DoxyCodeLine{80     Accessor(\textcolor{keyword}{const} cytnx\_int64 \&min, \textcolor{keyword}{const} cytnx\_int64 \&max, \textcolor{keyword}{const} cytnx\_int64 \&step);}
\DoxyCodeLine{81 }
\DoxyCodeLine{82     \textcolor{comment}{// copy constructor:}}
\DoxyCodeLine{83     Accessor(\textcolor{keyword}{const} Accessor \&rhs);}
\DoxyCodeLine{84     \textcolor{comment}{// copy assignment:}}
\DoxyCodeLine{85     Accessor \&operator=(\textcolor{keyword}{const} Accessor \&rhs);}
\DoxyCodeLine{87 }

    ...
    namespace tn_algo{
        ...
        class MPS{
            ...
            public:
                ...
                MPS(const cytnx_uint64 &N, const cytnx_uint64 &phys_dim, const cytnx_uint64 &virt_dim, const cytnx_int64 &dtype=Type.Double, const cytnx_int64 &mps_type=0): _impl(new MPS_impl()){
                    this->Init(N,phys_dim, virt_dim,dtype,mps_type);
                };

                MPS(const cytnx_uint64 &N, const std::vector<cytnx_uint64> &vphys_dim, const cytnx_uint64 &virt_dim, const cytnx_int64 &dtype=Type.Double, const cytnx_int64 &mps_type=0): _impl(new MPS_impl()){

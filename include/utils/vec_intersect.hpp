...
namespace cytnx{
    ...
    std::vector<std::vector<cytnx_int64> > vec2d_intersect( const std::vector<std::vector<cytnx_int64> > &inL, const std::vector<std::vector<cytnx_int64> > &inR, const bool &sorted_L=false, const bool &sorted_R=false);

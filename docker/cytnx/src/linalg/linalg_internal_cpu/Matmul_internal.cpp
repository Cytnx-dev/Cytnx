...
namespace cytnx{
    namespace linalg_internal{
        ...
        template<class T1>
        void Matmul_driver(T1 *out, const T1 *inl, const T1 *inr, const cytnx_int32 &Ml, const cytnx_int32 &Comm, const cytnx_int32 &Nr)
        {
        ...
        void Matmul_internal_cd(boost::intrusive_ptr<Storage_base> &out, const boost::intrusive_ptr<Storage_base> &inl, const boost::intrusive_ptr<Storage_base> &inr, const cytnx_int32 &Ml, const cytnx_int32 &Comm, const cytnx_int32 &Nr){
                ...
                zgemm((char*)"N",(char*)"N",&Nr, &Ml, &Comm, &alpha, _inr, &Nr, _inl,&Comm, &beta, _out, &Nr);

        }
        
        void Matmul_internal_cf(boost::intrusive_ptr<Storage_base> &out, const boost::intrusive_ptr<Storage_base> &inl, const boost::intrusive_ptr<Storage_base> &inr, const cytnx_int32 &Ml, const cytnx_int32 &Comm, const cytnx_int32 &Nr){
                ...
                cgemm((char*)"N",(char*)"N",&Nr, &Ml, &Comm, &alpha, _inr, &Nr, _inl,&Comm, &beta, _out, &Nr);

        }

        void Matmul_internal_d(boost::intrusive_ptr<Storage_base> &out, const boost::intrusive_ptr<Storage_base> &inl, const boost::intrusive_ptr<Storage_base> &inr, const cytnx_int32 &Ml, const cytnx_int32 &Comm, const cytnx_int32 &Nr){
                cytnx_double* _out = (cytnx_double*)out->Mem;
                cytnx_double* _inl = (cytnx_double*)inl->Mem;
                cytnx_double* _inr = (cytnx_double*)inr->Mem;

                cytnx_double alpha = 1, beta=0;
                dgemm((char*)"N",(char*)"N",&Nr, &Ml, &Comm, &alpha, _inr, &Nr, _inl,&Comm, &beta, _out, &Nr);
        }

        void Matmul_internal_f(boost::intrusive_ptr<Storage_base> &out, const boost::intrusive_ptr<Storage_base> &inl, const boost::intrusive_ptr<Storage_base> &inr, const cytnx_int32 &Ml, const cytnx_int32 &Comm, const cytnx_int32 &Nr){
                cytnx_float* _out = (cytnx_float*)out->Mem;
                cytnx_float* _inl = (cytnx_float*)inl->Mem;
                cytnx_float* _inr = (cytnx_float*)inr->Mem;

                cytnx_float alpha = 1, beta=0;
                sgemm((char*)"N",(char*)"N",&Nr, &Ml, &Comm, &alpha, _inr, &Nr, _inl,&Comm, &beta, _out, &Nr);
        }

        void Matmul_internal_i64(boost::intrusive_ptr<Storage_base> &out, const boost::intrusive_ptr<Storage_base> &inl, const boost::intrusive_ptr<Storage_base> &inr, const cytnx_int32 &Ml, const cytnx_int32 &Comm, const cytnx_int32 &Nr){

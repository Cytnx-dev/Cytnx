...
if(USE_CUDA)
    ...
    # CUDA 12+ moved Thrust/CUB into include/cccl/; add it when present.
    if(EXISTS "${CUDAToolkit_INCLUDE_DIRS}/../../../include/cccl")
      get_filename_component(_cccl_dir "${CUDAToolkit_INCLUDE_DIRS}/../../../include/cccl" ABSOLUTE)
      target_include_directories(cytnx PRIVATE "${_cccl_dir}")
    elseif(EXISTS "${CUDAToolkit_INCLUDE_DIRS}/../../include/cccl")
      get_filename_component(_cccl_dir "${CUDAToolkit_INCLUDE_DIRS}/../../include/cccl" ABSOLUTE)
      target_include_directories(cytnx PRIVATE "${_cccl_dir}")
    endif()

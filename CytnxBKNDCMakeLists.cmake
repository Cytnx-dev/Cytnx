...
if(USE_CUDA)
    ...
    if(USE_CUTENSOR)
        ...
        if(CUTENSOR_FOUND)
            ...
            target_include_directories(cytnx PUBLIC $<BUILD_INTERFACE:${CUTENSOR_INCLUDE_DIRS}>)
    ...
    if(USE_CUQUANTUM)
        ...
        if(CUQUANTUM_FOUND)
            ...
            target_include_directories(cytnx PUBLIC $<BUILD_INTERFACE:${CUQUANTUM_INCLUDE_DIRS}>)

...
def normal_(Sin: cytnx.cytnx.Storage, mean: typing.SupportsFloat | typing.SupportsIndex, std: typing.SupportsFloat | typing.SupportsIndex, seed: typing.SupportsInt | typing.SupportsIndex = -1) -> None:
    ...
@typing.overload
def normal_(Tin: cytnx.cytnx.UniTensor, mean: typing.SupportsFloat | typing.SupportsIndex, std: typing.SupportsFloat | typing.SupportsIndex, seed: typing.SupportsInt | typing.SupportsIndex = -1) -> None:
    ...
@typing.overload
...
def uniform_(Sin: cytnx.cytnx.Storage, low: typing.SupportsFloat | typing.SupportsIndex = 0.0, high: typing.SupportsFloat | typing.SupportsIndex = 1.0, seed: typing.SupportsInt | typing.SupportsIndex = -1) -> None:
    ...
@typing.overload
def uniform_(Tin: cytnx.cytnx.UniTensor, low: typing.SupportsFloat | typing.SupportsIndex = 0.0, high: typing.SupportsFloat | typing.SupportsIndex = 1.0, seed: typing.SupportsInt | typing.SupportsIndex = -1) -> None:
    ...

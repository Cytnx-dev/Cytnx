...
namespace UserGuideTest {
  ...
  TEST(UserGuide, 1_1_ex1){OUT_REDIRECT
#include "guide_codes/1_1_ex1.cpp"
                             OUT_RESET}

  TEST(UserGuide, 1_2_ex1){OUT_REDIRECT
#include "guide_codes/1_2_ex1.cpp"
  ...
  TEST(UserGuide, 2_1_ex1){OUT_REDIRECT
#include "guide_codes/2_1_ex1.cpp"
                             OUT_RESET}

  // 2.2 Number of GPUs
  TEST(UserGuide, 2_2_ex1){OUT_REDIRECT
...
// 3.1.3 Tensor with different dtype and device
  ...
  TEST(UserGuide, 3_1_4_ex1){OUT_REDIRECT
...
#include "guide_codes/3_1_6_ex1.cpp"
  ...
  // 3.2.1 reshape
  TEST(UserGuide, 3_2_1_ex1){OUT_REDIRECT
#include "guide_codes/3_2_1_ex1.cpp"
                               OUT_RESET}

  TEST(UserGuide, 3_2_1_ex2){OUT_REDIRECT
#include "guide_codes/3_2_1_ex2.cpp"
                               OUT_RESET}

  // 3.2.2 permute
  TEST(UserGuide, 3_2_2_ex1){OUT_REDIRECT
#include "guide_codes/3_2_2_ex1.cpp"
                               OUT_RESET}

  TEST(UserGuide, 3_2_2_ex2){OUT_REDIRECT
#include "guide_codes/3_2_1_ex2.cpp"
                               OUT_RESET}

  // 3.3 Accessing elements
  // 3.3.1 Get elements
  TEST(UserGuide, 3_3_1_ex1){OUT_REDIRECT
#include "guide_codes/3_3_1_ex1.cpp"
                               OUT_RESET}

  TEST(UserGuide, 3_3_1_ex2){OUT_REDIRECT
#include "guide_codes/3_3_1_ex2.cpp"
                               OUT_RESET}

  // 3.3.2 Get elements
  TEST(UserGuide, 3_3_2_ex1){OUT_REDIRECT
#include "guide_codes/3_3_2_ex1.cpp"
  ...
  */
  ...
  TEST(UserGuide, 3_4_2_ex1){OUT_REDIRECT
#include "guide_codes/3_4_2_ex1.cpp"
                               OUT_RESET}

  // 3.4.3 Tensor-Tensor arithmetic
  TEST(UserGuide, 3_4_3_ex1){OUT_REDIRECT
...
#include "guide_codes/3_4_4_ex1.cpp"
  ...
  TEST(UserGuide, 3_6_ex1){OUT_REDIRECT
#include "guide_codes/3_6_ex1.cpp"
                             OUT_RESET}

  TEST(UserGuide, 3_6_ex2){OUT_REDIRECT
#include "guide_codes/3_6_ex2.cpp"
                             OUT_RESET}

  // 3.7 Save/Load
  // 3.7.1 Save a Tensor
  TEST(UserGuide, 3_7_1_ex1){OUT_REDIRECT
#include "guide_codes/3_7_1_ex1.cpp"
                               OUT_RESET}

  // 3.7.2 Load a Tensor
  TEST(UserGuide, 3_7_2_ex1){OUT_REDIRECT
#include "guide_codes/3_7_2_ex1.cpp"
                               OUT_RESET}

  // 3.8 When will data be copied?
  // 3.8.1 Reference to & Copy of objects
  TEST(UserGuide, 3_8_1_ex1){OUT_REDIRECT
#include "guide_codes/3_8_1_ex1.cpp"
                               OUT_RESET}

  TEST(UserGuide, 3_8_1_ex2){OUT_REDIRECT
#include "guide_codes/3_8_1_ex2.cpp"
                               OUT_RESET}

  // 3.8.2 Permute
  TEST(UserGuide, 3_8_2_ex1_2_3){OUT_REDIRECT_FILE("3_8_2_ex1")
#include "guide_codes/3_8_2_ex1.cpp"
                                   OUT_RESET OUT_REDIRECT_FILE("3_8_2_ex2")
#include "guide_codes/3_8_2_ex2.cpp"
                                     OUT_RESET OUT_REDIRECT_FILE("3_8_2_ex3")
#include "guide_codes/3_8_2_ex3.cpp"
                                       OUT_RESET}

  // 3.8.2 Contiguous
  TEST(UserGuide, 3_8_3_ex1_2){OUT_REDIRECT_FILE("3_8_3_ex1")
#include "guide_codes/3_8_3_ex1.cpp"
                                 OUT_RESET OUT_REDIRECT_FILE("3_8_3_ex2")
#include "guide_codes/3_8_3_ex2.cpp"
                                   OUT_RESET}

  // 4. Storage
  // 4.1 Creating a Storage
  TEST(UserGuide, 4_1_ex1){OUT_REDIRECT
#include "guide_codes/4_1_ex1.cpp"
                             OUT_RESET}

  // 4.1.1 Type conversion
  TEST(UserGuide, 4_1_1_ex1){OUT_REDIRECT
...
// 4.1.2 Transfer between devices
  ...
  TEST(UserGuide, 4_1_3_ex1){OUT_REDIRECT
#include "guide_codes/4_1_3_ex1.cpp"
                               OUT_RESET}

  // 4.2 Accessing elements
  // 4.2.1 Get/Set elements
  TEST(UserGuide, 4_2_1_ex1){OUT_REDIRECT
#include "guide_codes/4_2_1_ex1.cpp"
                               OUT_RESET}

  TEST(UserGuide, 4_2_1_ex2){OUT_REDIRECT
...
#include "guide_codes/4_2_2_ex2.cpp"
  ...
  // 4.3 Increase size
  // 4.3.1 append
  TEST(UserGuide, 4_3_1_ex1){OUT_REDIRECT
#include "guide_codes/4_3_1_ex1.cpp"
                               OUT_RESET}

  // 4.3.2 resize
  TEST(UserGuide, 4_3_2_ex1){OUT_REDIRECT
#include "guide_codes/4_3_2_ex1.cpp"
                               OUT_RESET}

// 4.4 From/To C++ .vector
#ifdef UNI_GPU
  TEST(UserGuide, 4_4_ex1){OUT_REDIRECT
  #include "guide_codes/4_4_ex1.cpp"
                             OUT_RESET}
#endif

  TEST(UserGuide, 4_4_ex2){OUT_REDIRECT
...
#include "guide_codes/7_8_1_ex2.cpp"
  ...
  TEST(UserGuide, 8_1_2_ex1_2){OUT_REDIRECT_FILE("8_1_2_ex1")
...
#include "guide_codes/8_1_2_ex2.cpp"
  ...
  // 10. Iterative solver
  // 10.1 LinOp class
  TEST(UserGuide, 10_1_ex1){OUT_REDIRECT
#include "guide_codes/10_1_ex1.cpp"
                              OUT_RESET}

  // 10.1.2 Inherit the LinOp class
  TEST(UserGuide, 10_1_2_ex1){OUT_REDIRECT

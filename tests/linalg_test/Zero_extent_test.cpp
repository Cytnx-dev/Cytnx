  ...
  namespace test {
    namespace {
      ...
      TEST(ZeroExtentLinalgTest, ProductsReturnEmptyOrAdditiveIdentity) {
        ...
        ExpectEmpty(linalg::Matmul(Tensor({0, 2}, Type.Double), Tensor({2, 3}, Type.Double)),
                    {0, 3}, Type.Double);
        ...
        ExpectEmpty(linalg::Kron(Tensor({0, 2}, Type.Double), Tensor({3, 4}, Type.Double)), {0, 8},
                    Type.Double);
        ExpectEmpty(linalg::Matmul_dg(Tensor({0}, Type.Double), Tensor({0, 3}, Type.Double)),
                    {0, 3}, Type.Double);

        Tensor contracted = linalg::Tensordot(Tensor({2, 0, 3}, Type.Double),
                                              Tensor({4, 0, 5}, Type.Double), {1}, {1});
        ...
        ExpectEmpty(
          linalg::Directsum(Tensor({0, 2}, Type.Double), Tensor({0, 3}, Type.Double), {0}), {0, 5},
          Type.Double);
      }

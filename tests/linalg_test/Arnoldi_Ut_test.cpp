...
namespace cytnx {
  namespace test {
    ...
    TWO lowest states (k=2). Tests the fermionic ARPACK matvec and the BlockFermionicUniTensor
    ...
    mutually orthogonal. (ARPACK's real driver packs the eigenvector as complex with zero imaginary
    part for a real eigenvalue; ferm_fidelity uses the magnitude |<v|w>| so it handles that.)
    ====================*/

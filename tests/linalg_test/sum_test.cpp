...
namespace cytnx {
  namespace test {
    namespace {
      ...
      // tests. To work around this limitation, we use a static class member. For more details,
      // refer to: https://stackoverflow.com/a/22272614
      template <>
       ...
       */
      TEST(LinalgSumHeterogeneousMagnitudeTest, RecoversTermsLostByNaiveAccumulationDouble) {
      ...
      TEST(LinalgSumHeterogeneousMagnitudeTest, RecoversTermsLostByNaiveAccumulationFloat) {
        constexpr int N = 1024;

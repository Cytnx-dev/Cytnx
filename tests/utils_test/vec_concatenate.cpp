...
TEST_F(VecTest, vec_concatenate) {
  ...
  EXPECT_EQ(std::vector<cytnx::cytnx_uint64>({1,15,7,1,15}),cytnx::vec_concatenate(ui64v,ui64v2));
  EXPECT_EQ(std::vector<cytnx::cytnx_uint32>({1,15,7,1,15}),cytnx::vec_concatenate(ui32v,ui32v2));
  EXPECT_EQ(std::vector<cytnx::cytnx_uint16>({1,15,7,1,15}),cytnx::vec_concatenate(ui16v,ui16v2));
  EXPECT_EQ(std::vector<cytnx::cytnx_int64>({1,15,7,1,15}),cytnx::vec_concatenate(i64v,i64v2));
  EXPECT_EQ(std::vector<cytnx::cytnx_int32>({1,15,7,1,15}),cytnx::vec_concatenate(i32v,i32v2));
  EXPECT_EQ(std::vector<cytnx::cytnx_int16>({1,15,7,1,15}),cytnx::vec_concatenate(i16v,i16v2));
  EXPECT_EQ(std::vector<cytnx::cytnx_double>({1,15,7,1,15}),cytnx::vec_concatenate(doublev,doublev2));
  EXPECT_EQ(std::vector<cytnx::cytnx_float>({1,15,7,1,15}),cytnx::vec_concatenate(floatv,floatv2));
  EXPECT_EQ(std::vector<cytnx::cytnx_complex128>({1,15,7,1,15}),cytnx::vec_concatenate(c128v,c128v2));
  EXPECT_EQ(std::vector<cytnx::cytnx_complex64>({1,15,7,1,15}),cytnx::vec_concatenate(c64v,c64v2));

...
namespace cytnx {
  namespace test {
    namespace {
      ...
      using vector_typelist =
        ::testing::Types<cytnx_int64, cytnx_uint64, cytnx_int32, cytnx_uint32, cytnx_double,
                         cytnx_float, cytnx_uint16, cytnx_int16>;
      template <class>
      ...
      using TestingValueDTypes = std::tuple<Scalar, cytnx_complex128, cytnx_complex64, cytnx_double,
                                            cytnx_float, cytnx_uint64, cytnx_int64, cytnx_uint32,
                                            cytnx_int32, cytnx_uint16, cytnx_int16, cytnx_bool>;
      ...
      struct StoragePutValue : testing::Test {
         ...
         *
         * @return `std::false_type{}` if the given value cannot be converted to the data type of
         * the storage, otherwise, return the converted value
         */
      ...
      TEST_F(StorageTest, FromfileRejectsCountLargerThanFile) {
        const std::string path =
          ::testing::TempDir() + "cytnx_storage_fromfile_oversized_count.bin";
        std::remove(path.c_str());
        const RemoveFileOnExit cleanup(path);
      ...
      TEST(TypePromotion, MakeFloatingPointIntegralToDouble) {
        ...
        static_assert(
          std::is_same_v<Type_class::make_floating_point_t<cytnx_uint64>, cytnx_double>);
      ...
      TEST(TypePromotion, MakeFloatingPointFloatingUnchanged) {
        static_assert(
          std::is_same_v<Type_class::make_floating_point_t<cytnx_double>, cytnx_double>);
      ...
      TEST(StorageImplementationTyped, ValueTypeAndDtypeValue) {
        static_assert(
          std::is_same_v<StorageImplementation<cytnx_double>::value_type, cytnx_double>);

#ifndef CYTNX_TESTS_BLOCKUNITENSOR_TEST_H_
#define CYTNX_TESTS_BLOCKUNITENSOR_TEST_H_
    ...
    class BlockUniTensorTest : public ::testing::Test {
     public:
      ...
      UniTensor UT_diag = UniTensor({Bdiag, Bdiag.redirect()}, std::vector<std::string>({"0", "1"}),
                                    1, Type.ComplexDouble, Device.cpu, true);
...
#endif  // CYTNX_TESTS_BLOCKUNITENSOR_TEST_H_

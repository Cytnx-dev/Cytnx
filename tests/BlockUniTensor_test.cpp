...
namespace cytnx {
  namespace test {
    ...
    // preserved, symmetry-forbidden entries stay zero, and convert_from returns *this for chaining.
    ...
    // default tol=0, but a large tol or force=true tolerates it (the forbidden entry is dropped and
    // the allowed entries reproduce the original block exactly).

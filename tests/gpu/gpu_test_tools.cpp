...
namespace cytnx {
  namespace TestTools {
          ...
          case Type.Double:
            for (cytnx_uint64 i = 0; i < size; i++) {
              if (abs(stor1.at<cytnx_double>(i) - stor2.at<cytnx_double>(i)) > tol) {
                std::cout << "[AreNearlyEqStorage] element" << i << " : "
                          << stor1.at<cytnx_double>(i) << " != " << stor2.at<cytnx_double>(i)
                          << std::endl;
                return false;
              }
            }
          ...
          case Type.Float:
            for (cytnx_uint64 i = 0; i < size; i++) {
              if (abs(stor1.at<cytnx_float>(i) - stor2.at<cytnx_float>(i)) > tol) {
                std::cout << "[AreNearlyEqStorage] element" << i << " : "
                          << stor1.at<cytnx_float>(i) << " != " << stor2.at<cytnx_float>(i)
                          << std::endl;
                return false;
              }
            }
          ...
          case Type.Int64:
            for (cytnx_uint64 i = 0; i < size; i++) {
              if (abs(stor1.at<cytnx_int64>(i) - stor2.at<cytnx_int64>(i)) > tol) {
                std::cout << "[AreNearlyEqStorage] element" << i << " : "
                          << stor1.at<cytnx_int64>(i) << " != " << stor2.at<cytnx_int64>(i)
                          << std::endl;
                return false;
              }
            }
          ...
          case Type.Uint64:
            for (cytnx_uint64 i = 0; i < size; i++) {
              if (abs(static_cast<double>(stor1.at<cytnx_uint64>(i)) -
                ...
                std::cout << "[AreNearlyEqStorage] element" << i << " : "
                          << stor1.at<cytnx_uint64>(i) << " != " << stor2.at<cytnx_uint64>(i)
                          << std::endl;
                return false;
              }
            }
          ...
          case Type.Int32:
            for (cytnx_uint64 i = 0; i < size; i++) {
              if (abs(stor1.at<cytnx_int32>(i) - stor2.at<cytnx_int32>(i)) > tol) {
                std::cout << "[AreNearlyEqStorage] element" << i << " : "
                          << stor1.at<cytnx_int32>(i) << " != " << stor2.at<cytnx_int32>(i)
                          << std::endl;
                return false;
              }
            }
          ...
          case Type.Uint32:
            for (cytnx_uint64 i = 0; i < size; i++) {
              if (abs(static_cast<double>(stor1.at<cytnx_uint32>(i)) -
                ...
                std::cout << "[AreNearlyEqStorage] element" << i << " : "
                          << stor1.at<cytnx_uint32>(i) << " != " << stor2.at<cytnx_uint32>(i)
                          << std::endl;
                return false;
              }
            }
          ...
          case Type.Int16:
            for (cytnx_uint64 i = 0; i < size; i++) {
              if (abs(stor1.at<cytnx_int16>(i) - stor2.at<cytnx_int16>(i)) > tol) {
                std::cout << "[AreNearlyEqStorage] element" << i << " : "
                          << stor1.at<cytnx_int16>(i) << " != " << stor2.at<cytnx_int16>(i)
                          << std::endl;
                return false;
              }
            }
          ...
          case Type.Uint16:
            for (cytnx_uint64 i = 0; i < size; i++) {
              if (abs(static_cast<double>(stor1.at<cytnx_uint16>(i)) -
                ...
                std::cout << "[AreNearlyEqStorage] element" << i << " : "
                          << stor1.at<cytnx_uint16>(i) << " != " << stor2.at<cytnx_uint16>(i)
                          << std::endl;
                return false;
              }
            }
    ...
    bool AreElemSame(const Tensor& T1, const std::vector<cytnx_uint64>& idices1, const Tensor& T2,
      ...
      if (T1.dtype() != T2.dtype()) {
        std::cout << "[AreElemSame] T1 dtype " << T1.dtype() << "not equal to T2 dtype "
                  << T2.dtype() << std::endl;
        return false;
      }
      if (T1.device() != T2.device()) {

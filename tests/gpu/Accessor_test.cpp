...
TEST_F(AccessorTest, gpu_All) { EXPECT_EQ(all.type(), cytnx::Accessor::All); }

// Test Accessor::range() method
TEST_F(AccessorTest, gpu_Range) {
  EXPECT_EQ(range.type(), cytnx::Accessor::Range);
...
TEST_F(AccessorTest, gpu_Tilend) {
  EXPECT_EQ(tilend.type(), cytnx::Accessor::Tilend);
...
TEST_F(AccessorTest, gpu_Step) {
  EXPECT_EQ(step.type(), cytnx::Accessor::Step);
  EXPECT_EQ(step._step, 3);
}

// Test Accessor::constructor with list
TEST_F(AccessorTest, gpu_ConstructorWithList) {
  EXPECT_EQ(list.type(), cytnx::Accessor::list);
...
TEST_F(AccessorTest, gpu_ListConstructor) {
...
TEST_F(AccessorTest, gpu_AllConstructor) {
  cytnx::Accessor A(":");
...
TEST_F(AccessorTest, gpu_RangeConstructor) {
...
TEST_F(AccessorTest, gpu_TilendConstructor) {
...
TEST_F(AccessorTest, gpu_StepConstructor) {
...
TEST_F(AccessorTest, gpu_CopyConstructor) {
  cytnx::Accessor A(2);
  cytnx::Accessor B = A;
...
TEST_F(AccessorTest, gpu_CopyAssignment) {
  cytnx::Accessor A(2);
  cytnx::Accessor B;
  B = A;
  EXPECT_EQ(A.type(), B.type());
...
TEST_F(AccessorTest, gpu_SingleConstructor) {
...
TEST_F(AccessorTest, gpu_AllGenerator) {

...
namespace cytnx {
  namespace gpu_test {
    ...
    TEST(CommonDataGen, GpuDenseGenNonDiag) {
    ...
    TEST(CommonDataGen, GpuU1SymGen) {
      // construct bonds
    ...
    TEST(CommonDataGen, GpuZ2SymGen) {
      // construct bonds
    ...
    TEST(CommonDataGen, GpuZ3SymGen) {
      // construct bonds
    ...
    TEST(CommonDataGen, GpuU1xZ2SymGen) {
      // construct bonds
    ...
    TEST(CommonDataGen, GpuU1SymZerosGen) {
      std::vector<std::vector<cytnx_int64>> qnums1 = {{0}, {1}, {0}, {2}};
      std::vector<cytnx_uint64> degs = {1, 2, 3, 4};
    ...
    TEST(CommonDataGen, GpuU1SymOneElemGen) {

...
namespace cytnx {
  namespace {
    ...
    TEST(Bond, GpuSimpleBondOperation) {
      Bond bd(4, BD_KET);
    ...
    TEST(Bond, GpuCombineBondNoSymmReg) {
      Bond bd1(3), bd2(2);
    ...
    TEST(Bond, GpuCombineBondNoSymmBraKet) {
    ...
    TEST(Bond, GpuCombindBondSymmV2) {

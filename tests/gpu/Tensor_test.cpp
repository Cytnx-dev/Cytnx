...
namespace cytnx {
  namespace gpu_test {
    ...
    TEST_F(TensorTest, GpuCopyConstructor) {
    ...
    TEST_F(TensorTest, GpuZeroExtentArithmetic) {
    ...
    TEST_F(TensorTest, GpuRankZeroScalarAccessAndBroadcast) {
      Tensor scalar({}, Type.Double, Device.cuda);

...
class MyOp2 : public LinOp {
  ...
  MyOp2(int dim): LinOp("mv", dim) {
    Tensor A = Tensor::Load("../../../tests/test_data_base/linalg/Lanczos_Gnd/lan_block_A.cytn").to(cytnx::Device.cuda);
    Tensor B = Tensor::Load("../../../tests/test_data_base/linalg/Lanczos_Gnd/lan_block_B.cytn").to(cytnx::Device.cuda);
    Tensor C = Tensor::Load("../../../tests/test_data_base/linalg/Lanczos_Gnd/lan_block_C.cytn").to(cytnx::Device.cuda);

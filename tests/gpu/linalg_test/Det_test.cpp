...
namespace cytnx {
  namespace gpu_test {
    namespace {
      ...
      MATCHER_P(ComplexDoubleEq, n,
                ::testing::PrintToString(n) + " (of type std::complex<double>)") {
        return ::testing::ExplainMatchResult(::testing::DoubleNear(n.real(), Tolerance(arg.real())),
                                             arg.real(), result_listener) &&
               ::testing::ExplainMatchResult(::testing::DoubleNear(n.imag(), Tolerance(arg.imag())),
                                             arg.imag(), result_listener);
      }

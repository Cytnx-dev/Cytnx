...
namespace cytnx {
  namespace {
    ...
    TEST(ArnoldiUt, GpuWhichLMTest) {
      std::string which = "LM";
      ExcuteTest(which);
    }

    // 1-2, test for 'which' = 'LR'
    TEST(ArnoldiUt, GpuWhichLRTest) {
      std::string which = "LR";
      ExcuteTest(which);
    }

    // 1-3, test for 'which' = 'LI'
    TEST(ArnoldiUt, GpuWhichLITest) {
      std::string which = "LI";
      ExcuteTest(which);
    }

    // 1-4, test for 'which' = 'SR'
    TEST(ArnoldiUt, GpuWhichSRTest) {
      std::string which = "SR";
      ExcuteTest(which);
    }

    // 1-5, test for 'which' = 'SI'
    TEST(ArnoldiUt, GpuWhichSITest) {
      std::string which = "SI";
      ExcuteTest(which);
    }
    ...
    /*
    TEST(ArnoldiUt, GpuAllDtypeTest) {
      std::string which = "LM";

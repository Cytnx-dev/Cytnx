...
namespace cytnx {
  namespace gpu_test {
    namespace {
      ...
      static std::string ans_data_root = CYTNX_TEST_DATA_DIR "/linalg/Svd/";
      // normal test
      ...
      TEST(Svd, GpuNoneIsUIsVT) {
        ...
        EXPECT_EQ(svdsUV.size(), 3)
          << "The number of the output of svd not correct. Line:" << __LINE__ << std::endl;

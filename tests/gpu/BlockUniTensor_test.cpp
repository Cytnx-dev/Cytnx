...
TEST_F(BlockUniTensorTest, gpu_device) { EXPECT_EQ(Spf.device(), Device.cuda); }
...
TEST_F(BlockUniTensorTest, gpu_Nblocks) { EXPECT_EQ(UT_pB.Nblocks(), 4); }

TEST_F(BlockUniTensorTest, gpu_reshape) { EXPECT_ANY_THROW(Spf.reshape({4, 1}, 1)); }

TEST_F(BlockUniTensorTest, gpu_reshape_) { EXPECT_ANY_THROW(Spf.reshape_({4, 1}, 1)); }

  ...
  namespace gpu_test {
    namespace {
      ...
      TEST_F(BlockUniTensorTest, GpuTrace) {
        ...
        // Trace(0, 1) contracts UT_diag's only two bonds, so the result is a
        // rank-0 scalar; read it with an empty locator (matches the CPU Trace
        // test after the rank-0 UniTensor change in #1026).
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
      ...
      TEST_F(BlockUniTensorTest, GpuRelabels) {
      ...
      TEST_F(BlockUniTensorTest, GpuRelabels2) {
...
#pragma GCC diagnostic pop
      ...
      TEST_F(BlockUniTensorTest, GpuRelabel) {
        auto tmp = BUT1.clone();
      ...
      TEST_F(BlockUniTensorTest, GpuRelabel2) {
        auto tmp = BUT1.clone();
      ...
      TEST_F(BlockUniTensorTest, GpuSyms) {
      ...
      TEST_F(BlockUniTensorTest, GpuNorm) {
      ...
      ====================*/
      TEST_F(BlockUniTensorTest, GpuInv) {
      ...
      describe:test power
      ====================*/
      TEST_F(BlockUniTensorTest, GpuPow) {
        const double tol = 1e-14;
      ...
      TEST_F(BlockUniTensorTest, GpuConj) {
        auto tmp = BUT4.Conj();
        ...
        for (cytnx_uint64 i = 0; i < 5; i++)
          for (cytnx_uint64 j = 0; j < 11; j++)
            for (cytnx_uint64 k = 0; k < 3; k++)
              for (cytnx_uint64 l = 0; l < 5; l++)
                if (BUT4.at({i, j, k, l}).exists()) {
                  // EXPECT_TRUE(Scalar(BUT4.at({i, j, k, l})-BUconjT4.at({i, j, k,
                  // l})).abs()<1e-5);
      ...
      TEST_F(BlockUniTensorTest, GpuTranspose) {
      ...
      TEST_F(BlockUniTensorTest, GpuDagger) {
      ...
      TEST_F(BlockUniTensorTest, GpuTruncate) {
      ...
      TEST_F(BlockUniTensorTest, GpuElemExist) {
        for (cytnx_uint64 i = 0; i < 5; i++)
          for (cytnx_uint64 j = 0; j < 11; j++)
            for (cytnx_uint64 k = 0; k < 3; k++)
              for (cytnx_uint64 l = 0; l < 5; l++)
      ...
      TEST_F(BlockUniTensorTest, GpuInit) {
        // different types
        ...
        EXPECT_NO_THROW(BkUt.Init({phy, phy.redirect(), aux}, {"a", "b", "c"}, 1,
                                  Type.ComplexDouble, Device.cuda, false, false));
        ...
        EXPECT_ANY_THROW(
          BkUt.Init({phy, phy}, {"a", "b"}, 1, Type.Float, Device.cuda, true, false));
      }

      TEST_F(BlockUniTensorTest, GpuInitByTensor) {
        // not a valid operation
        EXPECT_ANY_THROW(BkUt.Init_by_Tensor(tzero345, false, -1));
      }

      TEST_F(BlockUniTensorTest, GpuShape) {
        EXPECT_EQ(std::vector<cytnx_uint64>({2, 2, 1}), Spf.shape());
      }

      TEST_F(BlockUniTensorTest, GpuDtype) {
      ...
      TEST_F(BlockUniTensorTest, GpuDtypeStr) {
      ...
      TEST_F(BlockUniTensorTest, GpuDevice) { EXPECT_EQ(Spf.device(), Device.cuda); }

      TEST_F(BlockUniTensorTest, GpuDeviceStr) {
        EXPECT_EQ(Spf.device_str().substr(0, 18), "cytnx device: CUDA");
      }

      TEST_F(BlockUniTensorTest, GpuIsBlockform) {
        EXPECT_EQ(Spf.is_blockform(), true);
        EXPECT_EQ(utzero345.is_blockform(), false);
      }

      TEST_F(BlockUniTensorTest, GpuIsContiguous) {
        EXPECT_EQ(Spf.is_contiguous(), true);
        auto Spf_new = Spf.permute({2, 1, 0}, 1);
        EXPECT_EQ(Spf_new.is_contiguous(), false);
      }

      TEST_F(BlockUniTensorTest, GpuSetRowrank) {
      ...
      TEST_F(BlockUniTensorTest, GpuAstype) {
      ...
      TEST_F(BlockUniTensorTest, GpuNblocks) { EXPECT_EQ(UT_pB.Nblocks(), 4); }

      TEST_F(BlockUniTensorTest, GpuReshape) { EXPECT_ANY_THROW(Spf.reshape({4, 1}, 1)); }

      TEST_F(BlockUniTensorTest, GpuReshape2) { EXPECT_ANY_THROW(Spf.reshape_({4, 1}, 1)); }

      TEST_F(BlockUniTensorTest, GpuContiguous) {
      ...
      TEST_F(BlockUniTensorTest, GpuContiguous2) {
      ...
      TEST_F(BlockUniTensorTest, GpuSameData) {
      ...
      TEST_F(BlockUniTensorTest, GpuGetBlockByqnum) {
      ...
      TEST_F(BlockUniTensorTest, GpuGetBlockByidx) {
      ...
      TEST_F(BlockUniTensorTest, GpuGetBlocks) {
      ...
      TEST_F(BlockUniTensorTest, GpuGetBlocks2) {
      ...
      TEST_F(BlockUniTensorTest, GpuPutBlockByidx) {
      ...
      TEST_F(BlockUniTensorTest, GpuPutBlockByidx2) {
      ...
      TEST_F(BlockUniTensorTest, GpuPutBlockByqnum) {
      ...
      TEST_F(BlockUniTensorTest, GpuPutBlockByqnum2) {
      ...
      TEST_F(BlockUniTensorTest, GpuClone) {
      ...
      TEST_F(BlockUniTensorTest, GpuPermute1) {
        // rank-3 tensor
      ...
      TEST_F(BlockUniTensorTest, GpuPermute2) {
      ...
      TEST_F(BlockUniTensorTest, GpuPermute12) {
        // rank-3 tensor
        std::vector<cytnx_int64> a = {1, 2, 0};
      ...
      TEST_F(BlockUniTensorTest, GpuPermute22) {
        std::vector<cytnx_int64> a = {1, 0};
      ...
      TEST_F(BlockUniTensorTest, GpuContract1) {
        // two sparse matrix
      ...
      TEST_F(BlockUniTensorTest, GpuContract2) {
      ...
      TEST_F(BlockUniTensorTest, GpuContract3) {
        //// two 3 legs tensor
      ...
      TEST_F(BlockUniTensorTest, GpuAdd) {
        ...
        //     }
        BUT4 = BUT4.Load(data_dir + "OriginalBUT.cytnx").to(Device.cuda);
      ...
      TEST_F(BlockUniTensorTest, GpuSub) {
        using std::complex_literals::operator""i;
      ...
      TEST_F(BlockUniTensorTest, GpuMul) {
        auto out = BUT4.Mul(9);
        for (cytnx_uint64 i = 0; i < 5; i++)
          for (cytnx_uint64 j = 0; j < 11; j++)
            for (cytnx_uint64 k = 0; k < 3; k++)
      ...
      TEST_F(BlockUniTensorTest, GpuDiv) {
        auto out = BUT4.Div(9);
        for (cytnx_uint64 i = 0; i < 5; i++)
          for (cytnx_uint64 j = 0; j < 11; j++)
            for (cytnx_uint64 k = 0; k < 3; k++)
      ...
      TEST_F(BlockUniTensorTest, GpuGroupBasis) {
      ...
      TEST_F(BlockUniTensorTest, GpuGetQindices) {
      ...
      TEST_F(BlockUniTensorTest, GpuGetItoi) {
      ...
      TEST_F(BlockUniTensorTest, GpuAtForSparse) {

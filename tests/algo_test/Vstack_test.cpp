...
namespace cytnx {
  namespace test {
    ...
    ====================*/
    TEST(Vstack, NonContiguousTensor) {
    ...
    ====================*/
    TEST(Vstack, ErrContainsMultiBoolType) {

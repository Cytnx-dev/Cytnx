...
namespace cytnx {
  namespace test {
    ...
    static_assert(variant_index_v<cytnx_cuda_complex64, Type_list_gpu> == Type_class::ComplexFloat);
    static_assert(is_complex_v<cytnx_cuda_complex128>);
    static_assert(is_complex_v<cytnx_cuda_complex64>);
    static_assert(std::is_same_v<Type_class::type_promote_gpu_t<cytnx_cuda_complex64, cytnx_double>,
                                 cytnx_cuda_complex128>);
    static_assert(std::is_same_v<Type_class::type_promote_gpu_t<cytnx_double, cytnx_cuda_complex64>,
                                 cytnx_cuda_complex128>);
#endif

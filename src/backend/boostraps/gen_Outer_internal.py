...
for t1,t1name in enumerate(DTYPES_FULL):
    for t2,t2name in enumerate(DTYPES_FULL):
        ...
        void Outer_internal_"+DTYPES_SIMPLE[t1]+"t"+DTYPES_SIMPLE[t2]+"(boost::intrusive_ptr<Storage_base> &out,\n\
            ...
            Outer_general<"+output_type+","+t1name+","+t2name+">(out, Lin, Rin, j1,j2);\n\
        }\n")

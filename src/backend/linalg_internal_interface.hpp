...
#include "backend/linalg_internal_cpu/Trace_internal.hpp"
...
#ifdef UNI_GPU
  #include "backend/linalg_internal_gpu/cuArithmetic_internal.hpp"
  #include "backend/linalg_internal_gpu/cuAbs_internal.hpp"
  #include "backend/linalg_internal_gpu/cuSvd_internal.hpp"
  #include "backend/linalg_internal_gpu/cuGeSvd_internal.hpp"
  #include "backend/linalg_internal_gpu/cuEigh_internal.hpp"
  #include "backend/linalg_internal_gpu/cuInvM_inplace_internal.hpp"
  #include "backend/linalg_internal_gpu/cuInv_inplace_internal.hpp"
  #include "backend/linalg_internal_gpu/cuConj_inplace_internal.hpp"
  #include "backend/linalg_internal_gpu/cuExp_internal.hpp"
  #include "backend/linalg_internal_gpu/cuGemm_internal.hpp"
  #include "backend/linalg_internal_gpu/cuGemm_Batch_internal.hpp"
  #include "backend/linalg_internal_gpu/cuMatmul_internal.hpp"
  #include "backend/linalg_internal_gpu/cuMatmul_dg_internal.hpp"
  #include "backend/linalg_internal_gpu/cuDiag_internal.hpp"
  #include "backend/linalg_internal_gpu/cuOuter_internal.hpp"
  #include "backend/linalg_internal_gpu/cuNorm_internal.hpp"
  #include "backend/linalg_internal_gpu/cuMatvec_internal.hpp"
  #include "backend/linalg_internal_gpu/cuVectordot_internal.hpp"
  #include "backend/linalg_internal_gpu/cuPow_internal.hpp"
  ...
  #include "backend/linalg_internal_gpu/cuMaxMin_internal.hpp"
  #include "backend/linalg_internal_gpu/cuKron_internal.hpp"
  #ifdef UNI_CUTENSOR
    #include "backend/linalg_internal_gpu/cuTensordot_internal.hpp"
  #endif

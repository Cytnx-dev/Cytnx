#ifndef CYTNX_BACKEND_UTILS_INTERNAL_GPU_CUSETELEMS_GPU_H_
#define CYTNX_BACKEND_UTILS_INTERNAL_GPU_CUSETELEMS_GPU_H_
...
#endif  // CYTNX_BACKEND_UTILS_INTERNAL_GPU_CUSETELEMS_GPU_H_

#ifndef CYTNX_BACKEND_LINALG_INTERNAL_CPU_MUL_INTERNAL_H_
#define CYTNX_BACKEND_LINALG_INTERNAL_CPU_MUL_INTERNAL_H_
...
namespace cytnx {
  namespace linalg_internal {
    // Typed MulInternalImpl (#941): TO is part of the signature, not recovered from a
    ...
    inline void MulInternalImpl(const boost::intrusive_ptr<StorageImplementation<TO>> &out,
...
#endif  // CYTNX_BACKEND_LINALG_INTERNAL_CPU_MUL_INTERNAL_H_

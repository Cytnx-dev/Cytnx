...
namespace cytnx {
  namespace linalg_internal {
    ...
    void Matmul_internal_cd(boost::intrusive_ptr<Storage_base>& out,
      ...
      zgemm((char*)"N", (char*)"N", &blsNr, &blsMl, &blsComm, &alpha, _inr, &blsNr, _inl, &blsComm,
            &beta, _out, &blsNr);
    }
    ...
    void Matmul_internal_cf(boost::intrusive_ptr<Storage_base>& out,
      ...
      blas_int blsMl = Ml, blsNr = Nr, blsComm = Comm;
      cgemm((char*)"N", (char*)"N", &blsNr, &blsMl, &blsComm, &alpha, _inr, &blsNr, _inl, &blsComm,
            &beta, _out, &blsNr);
    }
    ...
    void Matmul_internal_d(boost::intrusive_ptr<Storage_base>& out,
      ...
      blas_int blsMl = Ml, blsNr = Nr, blsComm = Comm;
      dgemm((char*)"N", (char*)"N", &blsNr, &blsMl, &blsComm, &alpha, _inr, &blsNr, _inl, &blsComm,
            &beta, _out, &blsNr);
    }
    ...
    void Matmul_internal_f(boost::intrusive_ptr<Storage_base>& out,
      ...
      blas_int blsMl = Ml, blsNr = Nr, blsComm = Comm;
      sgemm((char*)"N", (char*)"N", &blsNr, &blsMl, &blsComm, &alpha, _inr, &blsNr, _inl, &blsComm,
            &beta, _out, &blsNr);
    }

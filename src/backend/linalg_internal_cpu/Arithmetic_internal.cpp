...
namespace cytnx {
  namespace linalg_internal {
    ...
    void Arithmetic_internal_cdtcd(boost::intrusive_ptr<Storage_base> &out,
      ...
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_complex128, cytnx_complex128>(
    ...
    void Arithmetic_internal_cdtcf(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_complex128, cytnx_complex64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_cdtd(boost::intrusive_ptr<Storage_base> &out,
                                  ...
                                  const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_complex128, cytnx_double>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_cdtf(boost::intrusive_ptr<Storage_base> &out,
                                  ...
                                  const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_complex128, cytnx_float>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_cdtu64(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_complex128, cytnx_uint64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_cdti64(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_complex128, cytnx_int64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_cdtu32(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_complex128, cytnx_uint32>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_cdti32(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_complex128, cytnx_int32>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_cdti16(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_complex128, cytnx_int16>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_cdtu16(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_complex128, cytnx_uint16>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_cdtb(boost::intrusive_ptr<Storage_base> &out,
                                  ...
                                  const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_complex128, cytnx_bool>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_cftcd(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_complex64, cytnx_complex128>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_cftcf(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_complex64, cytnx_complex64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_cftd(boost::intrusive_ptr<Storage_base> &out,
                                  ...
                                  const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_complex64, cytnx_double>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_cftf(boost::intrusive_ptr<Storage_base> &out,
                                  ...
                                  const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_complex64, cytnx_float>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_cftu64(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_complex64, cytnx_uint64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_cfti64(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_complex64, cytnx_int64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_cftu32(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_complex64, cytnx_uint32>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_cfti32(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_complex64, cytnx_int32>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_cfti16(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_complex64, cytnx_int16>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_cftu16(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_complex64, cytnx_uint16>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_cftb(boost::intrusive_ptr<Storage_base> &out,
                                  ...
                                  const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_complex64, cytnx_bool>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_dtcd(boost::intrusive_ptr<Storage_base> &out,
                                  ...
                                  const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_double, cytnx_complex128>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_dtcf(boost::intrusive_ptr<Storage_base> &out,
                                  ...
                                  const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_double, cytnx_complex64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_dtd(boost::intrusive_ptr<Storage_base> &out,
                                 ...
                                 const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_double, cytnx_double>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_dtf(boost::intrusive_ptr<Storage_base> &out,
                                 ...
                                 const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_double, cytnx_float>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_dtu64(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_double, cytnx_uint64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_dti64(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_double, cytnx_int64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_dtu32(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_double, cytnx_uint32>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_dti32(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_double, cytnx_int32>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_dti16(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_double, cytnx_int16>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_dtu16(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_double, cytnx_uint16>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_dtb(boost::intrusive_ptr<Storage_base> &out,
                                 ...
                                 const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_double, cytnx_bool>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_ftcd(boost::intrusive_ptr<Storage_base> &out,
                                  ...
                                  const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_float, cytnx_complex128>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_ftcf(boost::intrusive_ptr<Storage_base> &out,
                                  ...
                                  const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_float, cytnx_complex64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_ftd(boost::intrusive_ptr<Storage_base> &out,
                                 ...
                                 const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_float, cytnx_double>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_ftf(boost::intrusive_ptr<Storage_base> &out,
                                 ...
                                 const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_float, cytnx_float>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_ftu64(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_float, cytnx_uint64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_fti64(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_float, cytnx_int64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_ftu32(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_float, cytnx_uint32>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_fti32(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_float, cytnx_int32>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_fti16(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_float, cytnx_int16>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_ftu16(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_float, cytnx_uint16>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_ftb(boost::intrusive_ptr<Storage_base> &out,
                                 ...
                                 const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_float, cytnx_bool>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u64tcd(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint64, cytnx_complex128>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u64tcf(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint64, cytnx_complex64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u64td(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint64, cytnx_double>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u64tf(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint64, cytnx_float>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u64tu64(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint64, cytnx_uint64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u64ti64(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint64, cytnx_int64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u64tu32(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint64, cytnx_uint32>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u64ti32(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint64, cytnx_int32>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u64ti16(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint64, cytnx_int16>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u64tu16(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint64, cytnx_uint16>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u64tb(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint64, cytnx_bool>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i64tcd(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int64, cytnx_complex128>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i64tcf(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int64, cytnx_complex64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i64td(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int64, cytnx_double>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i64tf(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int64, cytnx_float>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i64tu64(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int64, cytnx_uint64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i64ti64(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int64, cytnx_int64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i64tu32(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int64, cytnx_uint32>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i64ti32(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int64, cytnx_int32>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i64ti16(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int64, cytnx_int16>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i64tu16(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int64, cytnx_uint16>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i64tb(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int64, cytnx_bool>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u32tcd(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint32, cytnx_complex128>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u32tcf(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint32, cytnx_complex64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u32td(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint32, cytnx_double>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u32tf(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint32, cytnx_float>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u32tu64(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint32, cytnx_uint64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u32ti64(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint32, cytnx_int64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u32tu32(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint32, cytnx_uint32>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u32ti32(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint32, cytnx_int32>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u32ti16(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint32, cytnx_int16>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u32tu16(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint32, cytnx_uint16>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u32tb(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint32, cytnx_bool>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i32tcd(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int32, cytnx_complex128>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i32tcf(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int32, cytnx_complex64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i32td(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int32, cytnx_double>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i32tf(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int32, cytnx_float>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i32tu64(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int32, cytnx_uint64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i32ti64(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int32, cytnx_int64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i32tu32(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int32, cytnx_uint32>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i32ti32(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int32, cytnx_int32>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i32ti16(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int32, cytnx_int16>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i32tu16(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int32, cytnx_uint16>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i32tb(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int32, cytnx_bool>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i16tcd(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int16, cytnx_complex128>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i16tcf(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int16, cytnx_complex64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i16td(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int16, cytnx_double>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i16tf(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int16, cytnx_float>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i16tu64(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int16, cytnx_uint64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i16ti64(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int16, cytnx_int64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i16tu32(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int16, cytnx_uint32>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i16ti32(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int16, cytnx_int32>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i16ti16(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int16, cytnx_int16>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i16tu16(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int16, cytnx_uint16>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_i16tb(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_int16, cytnx_bool>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u16tcd(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint16, cytnx_complex128>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u16tcf(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint16, cytnx_complex64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u16td(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint16, cytnx_double>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u16tf(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint16, cytnx_float>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u16tu64(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint16, cytnx_uint64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u16ti64(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint16, cytnx_int64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u16tu32(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint16, cytnx_uint32>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u16ti32(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint16, cytnx_int32>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u16ti16(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint16, cytnx_int16>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u16tu16(
      ...
      const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint16, cytnx_uint16>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_u16tb(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_uint16, cytnx_bool>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_btcd(boost::intrusive_ptr<Storage_base> &out,
                                  ...
                                  const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_bool, cytnx_complex128>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_btcf(boost::intrusive_ptr<Storage_base> &out,
                                  ...
                                  const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_bool, cytnx_complex64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_btd(boost::intrusive_ptr<Storage_base> &out,
                                 ...
                                 const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_bool, cytnx_double>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_btf(boost::intrusive_ptr<Storage_base> &out,
                                 ...
                                 const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_bool, cytnx_float>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_btu64(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_bool, cytnx_uint64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_bti64(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_bool, cytnx_int64>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_btu32(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_bool, cytnx_uint32>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_bti32(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_bool, cytnx_int32>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_bti16(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_bool, cytnx_int16>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_btu16(boost::intrusive_ptr<Storage_base> &out,
                                   ...
                                   const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_bool, cytnx_uint16>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)
    ...
    void Arithmetic_internal_btb(boost::intrusive_ptr<Storage_base> &out,
                                 ...
                                 const std::vector<cytnx_uint64> &invmapper_R, const char &type) {
      if (type == 0)
        cytnx::linalg_internal::AddInternalInterface<cytnx_bool, cytnx_bool>(
          out, Lin, Rin, len, shape, invmapper_L, invmapper_R);
      else if (type == 1)

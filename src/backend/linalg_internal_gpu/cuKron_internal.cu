...
#define _TNinB_KRON_ 256
    ...
    void cuKron_general(boost::intrusive_ptr<Storage_base> &out,
      ...
      cuKron_kernel<<<NBlocks, _TNinB_KRON_, offset3 * sizeof(cytnx_uint64)>>>(
        _out, _Lin, _Rin, dshare_info, new_shape_acc.size(), offset1, offset2, offset3, TotalElem);
    ...
    void cuKron_internal_cdtcd(boost::intrusive_ptr<Storage_base> &out,
                               ...
                               const std::vector<cytnx_uint64> &shape1,
                               const std::vector<cytnx_uint64> &shape2) {
      cuKron_general<cuDoubleComplex, cuDoubleComplex, cuDoubleComplex>(out, Lin, Rin, shape1,
                                                                        shape2);
    }
    ...
    void cuKron_internal_cdtcf(boost::intrusive_ptr<Storage_base> &out,
                               ...
                               const std::vector<cytnx_uint64> &shape1,
                               const std::vector<cytnx_uint64> &shape2) {
      cuKron_general<cuDoubleComplex, cuDoubleComplex, cuFloatComplex>(out, Lin, Rin, shape1,
                                                                       shape2);
    }
    ...
    void cuKron_internal_cftcd(boost::intrusive_ptr<Storage_base> &out,
                               ...
                               const std::vector<cytnx_uint64> &shape1,
                               const std::vector<cytnx_uint64> &shape2) {
      cuKron_general<cuDoubleComplex, cuFloatComplex, cuDoubleComplex>(out, Lin, Rin, shape1,
                                                                       shape2);
    }

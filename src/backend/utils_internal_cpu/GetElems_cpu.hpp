#ifndef CYTNX_BACKEND_UTILS_INTERNAL_CPU_GETELEMS_CPU_H_
#define CYTNX_BACKEND_UTILS_INTERNAL_CPU_GETELEMS_CPU_H_
...
#endif  // CYTNX_BACKEND_UTILS_INTERNAL_CPU_GETELEMS_CPU_H_

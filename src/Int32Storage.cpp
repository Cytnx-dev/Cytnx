...
namespace cytnx{
    ...
    void Int32Storage::GetElem_byShape(boost::intrusive_ptr<Storage_base> &out, const std::vector<cytnx_uint64> &shape, const std::vector<cytnx_uint64> &mapper, const std::vector<cytnx_uint64> &len, const std::vector< std::vector<cytnx_uint64> > &locators){
        #ifdef UNI_DEBUG
                ...
                cytnx_int32* elem_ptr_     = static_cast<cytnx_int32*>(this->Mem);
                cytnx_int32* new_elem_ptr_ = static_cast<cytnx_int32*>(out->Mem ); 

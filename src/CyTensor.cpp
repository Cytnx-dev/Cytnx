...
namespace cytnx_extension{
    ...
    void CyTensor::_Save(std::fstream &f) const{
        ...
        cytnx_error_msg(this->_impl->uten_type_id==UTenType.Void,"[ERROR][CyTensor] cannot save an uninitialize CyTensor.%s","\n");

        //temporary disable:
        cytnx_error_msg(this->_impl->uten_type_id==UTenType.Sparse,"[ERROR] Save for SparseCyTensor is under developing!!%s","\n");

...
namespace cytnx {
  void Uint64Storage::Init(const unsigned long long &len_in, const int &device, const bool &init_zero) {
    ...
    if (device == Device.cpu) {
      ...
      if(init_zero) this->Mem = utils_internal::Calloc_cpu(this->cap, sizeof(cytnx_uint64));
      else this->Mem = utils_internal::Malloc_cpu(this->cap*sizeof(cytnx_uint64));
    } else {
#ifdef UNI_GPU

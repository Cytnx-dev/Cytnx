...
namespace cytnx{
    ...
    template std::vector<cytnx_complex128> vec_erase(const std::vector<cytnx_complex128> &,const std::vector<cytnx_uint64> &);
    template std::vector<cytnx_complex64> vec_erase(const std::vector<cytnx_complex64> &,const std::vector<cytnx_uint64> &);
    template std::vector<cytnx_double> vec_erase(const std::vector<cytnx_double> &,const std::vector<cytnx_uint64> &);
    template std::vector<cytnx_float> vec_erase(const std::vector<cytnx_float> &,const std::vector<cytnx_uint64> &);
    template std::vector<cytnx_int64> vec_erase(const std::vector<cytnx_int64> &,const std::vector<cytnx_uint64> &);
    template std::vector<cytnx_uint64> vec_erase(const std::vector<cytnx_uint64> &,const std::vector<cytnx_uint64> &);
    template std::vector<cytnx_int32> vec_erase(const std::vector<cytnx_int32> &,const std::vector<cytnx_uint64> &);
    template std::vector<cytnx_uint32> vec_erase(const std::vector<cytnx_uint32> &,const std::vector<cytnx_uint64> &);
    ...
    template std::vector<cytnx_extension::Bond> vec_erase(const std::vector<cytnx_extension::Bond> &,const std::vector<cytnx_uint64> &);
    ...
    template void vec_erase_(std::vector<cytnx_extension::Bond> &,const std::vector<cytnx_uint64> &);

...
namespace cytnx{
    ...
    template std::vector<cytnx_int16> vec_concatenate(const std::vector<cytnx_int16> &,const std::vector<cytnx_int16> &);
    template std::vector<cytnx_uint16> vec_concatenate(const std::vector<cytnx_uint16> &,const std::vector<cytnx_uint16> &);
    //template std::vector<cytnx_bool> vec_concatenate(const std::vector<cytnx_bool> &,const std::vector<cytnx_bool> &);
    ...
    template void vec_concatenate_(std::vector<cytnx_uint16> &out,const std::vector<cytnx_uint16> &,const std::vector<cytnx_uint16> &);
    template void vec_concatenate_(std::vector<cytnx_int16> &out,const std::vector<cytnx_int16> &,const std::vector<cytnx_int16> &);
    //template void vec_concatenate_(std::vector<cytnx_bool> &out,const std::vector<cytnx_bool> &,const std::vector<cytnx_bool> &);
}

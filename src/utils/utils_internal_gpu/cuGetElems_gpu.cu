...
namespace cytnx{
    namespace utils_internal{
        ...
        template<class T>
        __global__ void cuGetElems_kernel(T* d_out, T* d_in, cytnx_uint64 *offj, cytnx_uint64 *new_offj, cytnx_uint64 *locators, cytnx_uint64* picksize, cytnx_uint64 rank, cytnx_uint64 TotalElem){
        ...
        void cuGetElems_gpu_cd(void* out, void *in,const std::vector<cytnx_uint64> &offj, const std::vector<cytnx_uint64> &new_offj, const std::vector<std::vector<cytnx_uint64> >&locators, const cytnx_uint64 &TotalElem){
                //Start copy elem:
                ...
                cuGetElems_kernel<<<NBlocks,256>>>(new_elem_ptr_,elem_ptr_,d_offj,d_new_offj,d_locators,d_picksize,offj.size(),TotalElem);
        ...
        void cuGetElems_gpu_cf(void* out, void *in,const std::vector<cytnx_uint64> &offj, const std::vector<cytnx_uint64> &new_offj, const std::vector<std::vector<cytnx_uint64> >&locators, const cytnx_uint64 &TotalElem){
                //Start copy elem:
        ...
        void cuGetElems_gpu_d(void* out, void *in,const std::vector<cytnx_uint64> &offj, const std::vector<cytnx_uint64> &new_offj, const std::vector<std::vector<cytnx_uint64> >&locators, const cytnx_uint64 &TotalElem){
                //Start copy elem:
        ...
        void cuGetElems_gpu_f(void* out, void *in,const std::vector<cytnx_uint64> &offj, const std::vector<cytnx_uint64> &new_offj, const std::vector<std::vector<cytnx_uint64> >&locators, const cytnx_uint64 &TotalElem){
                //Start copy elem:
        ...
        void cuGetElems_gpu_i64(void* out, void *in,const std::vector<cytnx_uint64> &offj, const std::vector<cytnx_uint64> &new_offj, const std::vector<std::vector<cytnx_uint64> >&locators, const cytnx_uint64 &TotalElem){
                //Start copy elem:

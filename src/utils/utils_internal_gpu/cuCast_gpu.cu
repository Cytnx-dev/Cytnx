...
//-----------------------------
        ...
        void cuCast_gpu_dti16(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
        ...
        void cuCast_gpu_dtu16(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
        ...
        void cuCast_gpu_dtb(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
...
//-----------------------------
        ...
        void cuCast_gpu_fti16(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Int16Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_ftu16(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Uint16Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_ftb(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new BoolStorage());
                out->Init(len_in,alloc_device);
            }
...
//------------------------
        ...
        void cuCast_gpu_i64ti16(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Int16Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_i64tu16(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Uint16Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_i64tb(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new BoolStorage());
                out->Init(len_in,alloc_device);
            }
...
//-------------------------------
        ...
        void cuCast_gpu_u64ti16(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Int16Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_u64tu16(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Uint32Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_u64tb(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new BoolStorage());
                out->Init(len_in,alloc_device);
            }
...
//--------------------------------
        ...
        void cuCast_gpu_i32tu16(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Uint16Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_i32ti16(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Int16Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_i32tb(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new BoolStorage());
                out->Init(len_in,alloc_device);
            }
...
//----------------------------
        ...
        void cuCast_gpu_u32tu16(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Uint16Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_u32ti16(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Int16Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_u32tb(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new BoolStorage());
                out->Init(len_in,alloc_device);
            }
...
//------------------------------
        void cuCast_gpu_u16tcd(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new ComplexDoubleStorage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_u16tcf(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new ComplexFloatStorage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_u16td(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new DoubleStorage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_u16tf(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new FloatStorage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_u16ti64(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Int64Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_u16tu64(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Uint64Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_u16ti32(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Int32Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_u16tu32(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Uint32Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_u16tu16(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Uint16Storage());
                out->Init(len_in,alloc_device);
            }
            checkCudaErrors(cudaMemcpy(out->Mem,in->Mem,sizeof(cytnx_uint16)*len_in,cudaMemcpyDeviceToDevice)); 
        }
        void cuCast_gpu_u16ti16(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Int16Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_u16tb(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new BoolStorage());
                out->Init(len_in,alloc_device);
            }
...
//------------------------------
        void cuCast_gpu_i16tcd(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new ComplexDoubleStorage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_i16tcf(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new ComplexFloatStorage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_i16td(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new DoubleStorage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_i16tf(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new FloatStorage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_i16ti64(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Int64Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_i16tu64(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Uint64Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_i16ti32(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Int32Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_i16tu32(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Uint32Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_i16tu16(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Uint16Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_i16ti16(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Int16Storage());
                out->Init(len_in,alloc_device);
            }
            checkCudaErrors(cudaMemcpy(out->Mem,in->Mem,sizeof(cytnx_int16)*len_in,cudaMemcpyDeviceToDevice)); 
        }
        void cuCast_gpu_i16tb(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new BoolStorage());
                out->Init(len_in,alloc_device);
            }
...
//------------------------------
        void cuCast_gpu_btcd(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new ComplexDoubleStorage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_btcf(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new ComplexFloatStorage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_btd(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new DoubleStorage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_btf(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new FloatStorage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_bti64(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Int64Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_btu64(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Uint64Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_bti32(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Int32Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_btu32(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Uint32Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_btu16(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Uint16Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_bti16(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new Int16Storage());
                out->Init(len_in,alloc_device);
            }
        ...
        void cuCast_gpu_btb(const boost::intrusive_ptr<Storage_base>& in, boost::intrusive_ptr<Storage_base>& out, const unsigned long long &len_in, const int &alloc_device){
            if(alloc_device>=0){
                out = boost::intrusive_ptr<Storage_base>(new BoolStorage());
                out->Init(len_in,alloc_device);
            }
            checkCudaErrors(cudaMemcpy(out->Mem,in->Mem,sizeof(cytnx_bool)*len_in,cudaMemcpyDeviceToDevice)); 
        }

...
namespace cytnx {
    ...
    // Call cutensornet
    void cuTensornet_(const int32_t numInputs, void* R_d, int32_t nmodeR, int64_t* extentR, int32_t* modesR, void* rawDataIn_d[], int32_t* modesIn[], int32_t const numModesIn[], int64_t* extentsIn[], int64_t* stridesIn[], bool verbose){
    ...
    *******************************/
    ...
    HANDLE_ERROR( cutensornetCreateNetworkDescriptor(handle,
                        ...
                        nmodeR, extentR, /*stridesOut = */NULL, modesR,
    ...
    **********************/
    ...
    cuTensornet_(numInputs, R_d, res.shape().size(), (int64_t*)res.shape().data(), modes_res.data(), rawDataIn_d.data(), modesIn.data(), numModesIn.data(), extentsIn.data(), stridesIn.data(), verbose);

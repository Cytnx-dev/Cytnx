...
namespace cytnx{
    namespace random{
        void Make_uniform(Storage &Sin, const double &low, const double &high, const unsigned int &seed){
            cytnx_error_msg((Sin.dtype()<1) || (Sin.dtype()>4),"[ERROR][Random.Make_uniform] Uniform distribution only accept real/imag floating type.%s","\n");
            cytnx_error_msg(high<=low,"[ERROR][Random.Make_uniform] higher-bound should be > lower-bound.%s","\n");
        ...
        void Make_uniform(Tensor  &Tin, const double &low, const double &high, const unsigned int &seed){
            cytnx_error_msg((Tin.dtype()<1) || (Tin.dtype()>4),"[ERROR][Random.Make_uniform] Uniform distribution only accept real/imag floating type.%s","\n");
            cytnx_error_msg(high<=low,"[ERROR][Random.Make_uniform] higher-bound should be > lower-bound.%s","\n");
        ...
        void Make_uniform(UniTensor  &Tin, const double &low, const double &high, const unsigned int &seed){

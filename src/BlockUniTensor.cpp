...
namespace cytnx {
  ...
  void BlockUniTensor::print_block(const cytnx_int64 &idx, const bool &full_info,
    ...
    */
    ...
    beauty_print_block(this->_rowrank, this->_labels.size() - this->_rowrank,
                       this->_inner_to_outer_idx[idx], this->_bonds, this->_blocks[idx], file);
  ...
  void BlockUniTensor::print_blocks(const bool &full_info, std::ostream &file) const {
    file << "-------- start of print ---------\n";
  ...
  void BlockUniTensor::print_diagram(const bool &bond_info, std::ostream &file) const {

...
namespace cytnx {
  namespace linalg {
    ...
    static void Eig_Block_UT_internal(std::vector<cytnx::UniTensor> &outCyT, const UniTensor &Tin,
                                      const bool &is_V, const bool &row_v) {
    ...
    }  // Eig_Block_UT_internal

    static void Eig_BlockFermionic_UT_internal(std::vector<cytnx::UniTensor> &outCyT,
    ...
    }  // Eig_BlockFermionic_UT_internal
    ...
    std::vector<cytnx::UniTensor> Eig(const UniTensor &Tin, const bool &is_V, const bool &row_v) {
      ...
      if (Tin.uten_type() == UTenType.Dense) {
        ...
        Eig_Block_UT_internal(outCyT, Tin, is_V, row_v);

...
namespace cytnx{
    namespace linalg{
        Tensor Mod(const Tensor &Lt, const Tensor &Rt){
            cytnx_error_msg(Lt.device() != Rt.device(),"[Mod] error, two tensor cannot on different devices.%s","\n");
            ...
            if(Lt.shape().size()==1 && Lt.shape()[0]==1){
                ...
                cytnx_error_msg(Lt.shape() != Rt.shape(),"[Mod] error, the two tensor does not have the same shape.%s","\n");
                out.Init(Lt.shape(),Lt.dtype() < Rt.dtype()?Lt.dtype():Rt.dtype(),Lt.device());
            }
            ...
            if((Lt.is_contiguous() && Rt.is_contiguous())|| icnst){
                ...
                if(Lt.device() == Device.cpu){
                    cytnx::linalg_internal::lii.Ari_ii[Lt.dtype()][Rt.dtype()](out._impl->storage()._impl,Lt._impl->storage()._impl,Rt._impl->storage()._impl,out._impl->storage()._impl->size(),{},{},{},5);
                }else{
                    #ifdef UNI_GPU
                        checkCudaErrors(cudaSetDevice(Rt.device()));
                        cytnx::linalg_internal::lii.cuAri_ii[Lt.dtype()][Rt.dtype()](out._impl->storage()._impl,Lt._impl->storage()._impl,Rt._impl->storage()._impl,out._impl->storage()._impl->size(),{},{},{},5);
                    #else
                ...
                if(Lt.device() == Device.cpu){
                    cytnx::linalg_internal::lii.Ari_ii[Lt.dtype()][Rt.dtype()](out._impl->storage()._impl,Lt._impl->storage()._impl,Rt._impl->storage()._impl,Lt._impl->storage()._impl->size(),Lt._impl->shape(),Lt._impl->invmapper(),Rt._impl->invmapper(),5);
                }else{
                    #ifdef UNI_GPU
                        cytnx_error_msg(true, "[Mod][on GPU/CUDA] error two tensors must be contiguous. Call Contiguous_() or Contiguous() first%s","\n");
                    #else
                        cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                    #endif
                }
        ...
        Tensor Mod<cytnx_complex128>(const cytnx_complex128 &lc, const Tensor &Rt){
            ...
            if(Rt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Type.ComplexDouble][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                    checkCudaErrors(cudaSetDevice(Rt.device()));
                    cytnx::linalg_internal::lii.cuAri_ii[Type.ComplexDouble][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<cytnx_complex64>(const cytnx_complex64 &lc, const Tensor &Rt){
            ...
            if(Rt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Type.ComplexFloat][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                    checkCudaErrors(cudaSetDevice(Rt.device()));
                    cytnx::linalg_internal::lii.cuAri_ii[Type.ComplexFloat][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<cytnx_double>(const cytnx_double &lc, const Tensor &Rt){
            ...
            if(Rt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Type.Double][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                    cytnx::linalg_internal::lii.cuAri_ii[Type.Double][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<cytnx_float>(const cytnx_float &lc, const Tensor &Rt){
            ...
            if(Rt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Type.Float][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                    checkCudaErrors(cudaSetDevice(Rt.device()));
                    cytnx::linalg_internal::lii.cuAri_ii[Type.Float][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<cytnx_int64>(const cytnx_int64 &lc, const Tensor &Rt){
            ...
            if(Rt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Type.Int64][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                    cytnx::linalg_internal::lii.cuAri_ii[Type.Int64][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<cytnx_uint64>(const cytnx_uint64 &lc, const Tensor &Rt){
            ...
            if(Rt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Type.Uint64][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                    checkCudaErrors(cudaSetDevice(Rt.device()));
                    cytnx::linalg_internal::lii.cuAri_ii[Type.Uint64][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<cytnx_int32>(const cytnx_int32 &lc, const Tensor &Rt){
            ...
            if(Rt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Type.Int32][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                    checkCudaErrors(cudaSetDevice(Rt.device()));
                    cytnx::linalg_internal::lii.cuAri_ii[Type.Int32][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<cytnx_uint32>(const cytnx_uint32 &lc, const Tensor &Rt){
            ...
            if(Rt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Type.Uint32][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                    checkCudaErrors(cudaSetDevice(Rt.device()));
                    cytnx::linalg_internal::lii.cuAri_ii[Type.Uint32][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<cytnx_int16>(const cytnx_int16 &lc, const Tensor &Rt){
            ...
            if(Rt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Type.Int16][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                    checkCudaErrors(cudaSetDevice(Rt.device()));
                    cytnx::linalg_internal::lii.cuAri_ii[Type.Int16][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<cytnx_uint16>(const cytnx_uint16 &lc, const Tensor &Rt){
            ...
            if(Rt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Type.Uint16][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                    checkCudaErrors(cudaSetDevice(Rt.device()));
                    cytnx::linalg_internal::lii.cuAri_ii[Type.Uint16][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<cytnx_bool>(const cytnx_bool &lc, const Tensor &Rt){
            ...
            if(Rt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Type.Bool][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                    checkCudaErrors(cudaSetDevice(Rt.device()));
                    cytnx::linalg_internal::lii.cuAri_ii[Type.Bool][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<Scalar>(const Scalar &lc, const Tensor &Rt){
            ...
            if(Rt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[lc.dtype()][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                    checkCudaErrors(cudaSetDevice(Rt.device()));
                    cytnx::linalg_internal::lii.cuAri_ii[lc.dtype()][Rt.dtype()](out._impl->storage()._impl,Cnst._impl,Rt._impl->storage()._impl,Rt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<cytnx_complex128>(const Tensor &Lt, const cytnx_complex128 &rc){
            ...
            if(Lt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Lt.dtype()][Type.ComplexDouble](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                checkCudaErrors(cudaSetDevice(Lt.device()));
                cytnx::linalg_internal::lii.cuAri_ii[Lt.dtype()][Type.ComplexDouble](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<cytnx_complex64>(const Tensor &Lt, const cytnx_complex64 &rc){
            ...
            if(Lt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Lt.dtype()][Type.ComplexFloat](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                checkCudaErrors(cudaSetDevice(Lt.device()));
                cytnx::linalg_internal::lii.cuAri_ii[Lt.dtype()][Type.ComplexFloat](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<cytnx_double>(const Tensor &Lt, const cytnx_double &rc){
            ...
            if(Lt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Lt.dtype()][Type.Double](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                checkCudaErrors(cudaSetDevice(Lt.device()));
                cytnx::linalg_internal::lii.cuAri_ii[Lt.dtype()][Type.Double](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<cytnx_float>(const Tensor &Lt, const cytnx_float &rc){
           ...
           // Tensor out(Lt.shape(),Type.Float < Lt.dtype()?Type.Float:Lt.dtype(),Lt.device());
            ...
            if(Lt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Lt.dtype()][Type.Float](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                checkCudaErrors(cudaSetDevice(Lt.device()));
                cytnx::linalg_internal::lii.cuAri_ii[Lt.dtype()][Type.Float](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<cytnx_int64>(const Tensor &Lt, const cytnx_int64 &rc){
            ...
            if(Lt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Lt.dtype()][Type.Int64](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                checkCudaErrors(cudaSetDevice(Lt.device()));
                cytnx::linalg_internal::lii.cuAri_ii[Lt.dtype()][Type.Int64](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<cytnx_uint64>(const Tensor &Lt, const cytnx_uint64 &rc){
            ...
            if(Lt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Lt.dtype()][Type.Uint64](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                checkCudaErrors(cudaSetDevice(Lt.device()));
                cytnx::linalg_internal::lii.cuAri_ii[Lt.dtype()][Type.Uint64](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<cytnx_int32>(const Tensor &Lt, const cytnx_int32 &rc){
            ...
            if(Lt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Lt.dtype()][Type.Int32](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                checkCudaErrors(cudaSetDevice(Lt.device()));
                cytnx::linalg_internal::lii.cuAri_ii[Lt.dtype()][Type.Int32](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<cytnx_uint32>(const Tensor &Lt, const cytnx_uint32 &rc){
            ...
            if(Lt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Lt.dtype()][Type.Uint32](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                checkCudaErrors(cudaSetDevice(Lt.device()));
                cytnx::linalg_internal::lii.cuAri_ii[Lt.dtype()][Type.Uint32](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<cytnx_int16>(const Tensor &Lt, const cytnx_int16 &rc){
            ...
            if(Lt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Lt.dtype()][Type.Int16](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                checkCudaErrors(cudaSetDevice(Lt.device()));
                cytnx::linalg_internal::lii.cuAri_ii[Lt.dtype()][Type.Int16](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<cytnx_uint16>(const Tensor &Lt, const cytnx_uint16 &rc){
            ...
            if(Lt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Lt.dtype()][Type.Uint16](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                checkCudaErrors(cudaSetDevice(Lt.device()));
                cytnx::linalg_internal::lii.cuAri_ii[Lt.dtype()][Type.Uint16](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<cytnx_bool>(const Tensor &Lt, const cytnx_bool &rc){
            ...
            if(Lt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Lt.dtype()][Type.Bool](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                checkCudaErrors(cudaSetDevice(Lt.device()));
                cytnx::linalg_internal::lii.cuAri_ii[Lt.dtype()][Type.Bool](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
        ...
        Tensor Mod<Scalar>(const Tensor &Lt, const Scalar &rc){
            ...
            Tensor out;
            out._impl = Lt._impl->_clone_meta_only(); 
            out._impl->storage() = Storage(Lt._impl->storage().size(),rc.dtype() < Lt.dtype()?rc.dtype():Lt.dtype(),Lt.device());
            //Tensor out(Lt.shape(),Type.Bool < Lt.dtype()?Type.Bool:Lt.dtype(),Lt.device());

            if(Lt.device()==Device.cpu){
                cytnx::linalg_internal::lii.Ari_ii[Lt.dtype()][rc.dtype()](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
            }else{
                #ifdef UNI_GPU
                checkCudaErrors(cudaSetDevice(Lt.device()));
                cytnx::linalg_internal::lii.cuAri_ii[Lt.dtype()][rc.dtype()](out._impl->storage()._impl,Lt._impl->storage()._impl,Cnst._impl,Lt._impl->storage()._impl->size(),{},{},{},5);
                #else
                    cytnx_error_msg(true,"[Mod] fatal error, the tensor is on GPU without CUDA support.%s","\n"); 
                #endif 
            }        
...
namespace cytnx{
    namespace linalg{
        ...
        template cytnx::UniTensor Mod<cytnx_complex128>(const cytnx_complex128 &lc, const cytnx::UniTensor &Rt);
        template cytnx::UniTensor Mod<cytnx_complex64>(const cytnx_complex64 &lc, const cytnx::UniTensor &Rt);
        ...
        template cytnx::UniTensor Mod<cytnx_complex128>(const cytnx::UniTensor &Lt,const cytnx_complex128 &rc);
        template cytnx::UniTensor Mod<cytnx_complex64>(const cytnx::UniTensor &Lt,const cytnx_complex64 &rc);

...
namespace tor10{
    ...
    Tensor Sub(const Tensor &Lt, const Tensor &Rt){
        ...
        tor10_error_msg(!(Lt.is_contiguous() && Rt.is_contiguous()), "[Sub] error two tensors must be contiguous. Call Contiguous_() or Contiguous() first%s","\n");
    ...
    //-----------------------------------------------------------------------------------
    template<>
    Tensor Sub<tor10_complex128>(const tor10_complex128 &lc, const Tensor &Rt){
    ...
    template<>
    Tensor Sub<tor10_complex64>(const tor10_complex64 &lc, const Tensor &Rt){
    ...
    template<>
    Tensor Sub<tor10_double>(const tor10_double &lc, const Tensor &Rt){
    ...
    template<>
    Tensor Sub<tor10_float>(const tor10_float &lc, const Tensor &Rt){
    ...
    template<>
    Tensor Sub<tor10_int64>(const tor10_int64 &lc, const Tensor &Rt){
    ...
    template<>
    Tensor Sub<tor10_uint64>(const tor10_uint64 &lc, const Tensor &Rt){
    ...
    template<>
    Tensor Sub<tor10_int32>(const tor10_int32 &lc, const Tensor &Rt){
    ...
    template<>
    Tensor Sub<tor10_uint32>(const tor10_uint32 &lc, const Tensor &Rt){
    ...
    //-----------------------------------------------------------------------------------
    template<>
    Tensor Sub<tor10_complex128>(const Tensor &Lt, const tor10_complex128 &rc){
        Storage Cnst(1,tor10type.ComplexDouble);
    ...
    template<>
    Tensor Sub<tor10_complex64>(const Tensor &Lt, const tor10_complex64 &rc){
        Storage Cnst(1,tor10type.ComplexFloat);
    ...
    template<>
    Tensor Sub<tor10_double>(const Tensor &Lt, const tor10_double &rc){
        Storage Cnst(1,tor10type.Double);
    ...
    template<>
    Tensor Sub<tor10_float>(const Tensor &Lt, const tor10_float &rc){
        Storage Cnst(1,tor10type.Float);
    ...
    template<>
    Tensor Sub<tor10_int64>(const Tensor &Lt, const tor10_int64 &rc){
        Storage Cnst(1,tor10type.Int64);
    ...
    template<>
    Tensor Sub<tor10_uint64>(const Tensor &Lt, const tor10_uint64 &rc){
        Storage Cnst(1,tor10type.Uint64);
    ...
    template<>
    Tensor Sub<tor10_int32>(const Tensor &Lt, const tor10_int32 &rc){
        Storage Cnst(1,tor10type.Int32);
    ...
    template<>
    Tensor Sub<tor10_uint32>(const Tensor &Lt, const tor10_uint32 &rc){
        Storage Cnst(1,tor10type.Uint32);

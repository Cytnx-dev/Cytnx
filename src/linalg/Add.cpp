...
namespace cytnx{
    namespace linalg{
        ...
        CyTensor Add(const CyTensor &Lt, const CyTensor &Rt){
        ...
        template<class T>
        CyTensor Add(const T &lc, const CyTensor &Rt){
            CyTensor out = Rt.clone();
            if(Rt.is_blockform()){
                //developing
                cytnx_error_msg(true,"[Developing][Add][SparseCyTensor]%s","\n");
            }else{
        ...
        template CyTensor Add<cytnx_complex128>(const cytnx_complex128 &lc, const CyTensor &Rt);
        template CyTensor Add<cytnx_complex64>(const cytnx_complex64 &lc, const CyTensor &Rt);
        template CyTensor Add<cytnx_double>(const cytnx_double &lc, const CyTensor &Rt);
        template CyTensor Add<cytnx_float>(const cytnx_float &lc, const CyTensor &Rt);
        template CyTensor Add<cytnx_int64>(const cytnx_int64 &lc, const CyTensor &Rt);
        template CyTensor Add<cytnx_uint64>(const cytnx_uint64 &lc, const CyTensor &Rt);
        template CyTensor Add<cytnx_int32>(const cytnx_int32 &lc, const CyTensor &Rt);
        template CyTensor Add<cytnx_uint32>(const cytnx_uint32 &lc, const CyTensor &Rt);
        template CyTensor Add<cytnx_int16>(const cytnx_int16 &lc, const CyTensor &Rt);
        template CyTensor Add<cytnx_uint16>(const cytnx_uint16 &lc, const CyTensor &Rt);
        template CyTensor Add<cytnx_bool>(const cytnx_bool &lc, const CyTensor &Rt);

        //-----------------------------------------------------------------------------------
        template<>
        CyTensor Add<cytnx_complex128>(const CyTensor &Lt, const cytnx_complex128 &rc){
            return Add(rc,Lt);
        }
        template<>
        CyTensor Add<cytnx_complex64>(const CyTensor &Lt, const cytnx_complex64 &rc){
            return Add(rc,Lt);
        }
        template<>
        CyTensor Add<cytnx_double>(const CyTensor &Lt, const cytnx_double &rc){
            return Add(rc,Lt);
        }
        template<>
        CyTensor Add<cytnx_float>(const CyTensor &Lt, const cytnx_float &rc){
            return Add(rc,Lt);
        }
        template<>
        CyTensor Add<cytnx_int64>(const CyTensor &Lt, const cytnx_int64 &rc){
            return Add(rc,Lt);
        }
        template<>
        CyTensor Add<cytnx_uint64>(const CyTensor &Lt, const cytnx_uint64 &rc){
            return Add(rc,Lt);
        }
        template<>
        CyTensor Add<cytnx_int32>(const CyTensor &Lt, const cytnx_int32 &rc){
            return Add(rc,Lt);
        }
        template<>
        CyTensor Add<cytnx_uint32>(const CyTensor &Lt, const cytnx_uint32 &rc){
            return Add(rc,Lt);
        }
        template<>
        CyTensor Add<cytnx_int16>(const CyTensor &Lt, const cytnx_int16 &rc){
            return Add(rc,Lt);
        }
        template<>
        CyTensor Add<cytnx_uint16>(const CyTensor &Lt, const cytnx_uint16 &rc){
            return Add(rc,Lt);
        }
        template<>
        CyTensor Add<cytnx_bool>(const CyTensor &Lt, const cytnx_bool &rc){
            return Add(rc,Lt);
        }

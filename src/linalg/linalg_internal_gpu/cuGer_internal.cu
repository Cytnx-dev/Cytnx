...
namespace cytnx {
  namespace linalg_internal {
    ...
    void cuGer_internal_cd(boost::intrusive_ptr<Storage_base> &A, const boost::intrusive_ptr<Storage_base> &x,
                         const boost::intrusive_ptr<Storage_base> &y,
                         const Scalar &a){
        ...
        checkCudaErrors(
            cublasZgeru(cublasH, y->size(), x->size(), (cuDoubleComplex*)&alpha, _y, 1, _x, 1, _A, y->size())
        );
    ...
    void cuGer_internal_cf(boost::intrusive_ptr<Storage_base> &A, const boost::intrusive_ptr<Storage_base> &x,
                         const boost::intrusive_ptr<Storage_base> &y,
                         const Scalar &a){
        ...
        checkCudaErrors(
            cublasCgeru(cublasH, y->size(), x->size(), (cuFloatComplex*)&alpha, _y, 1, _x, 1, _A, y->size())
        );
    ...
    void cuGer_internal_d(boost::intrusive_ptr<Storage_base> &A, const boost::intrusive_ptr<Storage_base> &x,
                         const boost::intrusive_ptr<Storage_base> &y,
                         const Scalar &a){
    ...
    void cuGer_internal_f(boost::intrusive_ptr<Storage_base> &A, const boost::intrusive_ptr<Storage_base> &x,
                         const boost::intrusive_ptr<Storage_base> &y,
                         const Scalar &a){

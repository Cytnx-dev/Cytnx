...
namespace cytnx {
  ...
  namespace linalg_internal {
    ...
    void cuSvd_internal_cd(const boost::intrusive_ptr<Storage_base> &in,
      ...
      checkCudaErrors(
        cudaMemcpy(Mij, in->Mem, sizeof(cytnx_complex128) * M * N, cudaMemcpyDeviceToDevice));
      ...
      checkCudaErrors(cusolverDnZgesvd(
        cusolverH, jobv, jobu, N, M, Mij, ldA, (cytnx_double *)S->Mem, (cuDoubleComplex *)vT->Mem,
        ldu, (cuDoubleComplex *)U->Mem, ldvT, work, lwork, rwork, devinfo));
    ...
    void cuSvd_internal_cf(const boost::intrusive_ptr<Storage_base> &in,
      ...
      cytnx_int32 info;
      /// compute:
      checkCudaErrors(cusolverDnCgesvd(cusolverH, jobv, jobu, N, M, Mij, ldA, (cytnx_float *)S->Mem,
                                       (cuFloatComplex *)vT->Mem, ldu, (cuFloatComplex *)U->Mem,
    ...
    void cuSvd_internal_d(const boost::intrusive_ptr<Storage_base> &in,
      ...
      cytnx_int32 info;
      /// compute:
      checkCudaErrors(cusolverDnDgesvd(cusolverH, jobv, jobu, N, M, Mij, ldA,
    ...
    void cuSvd_internal_f(const boost::intrusive_ptr<Storage_base> &in,
      ...
      cytnx_int32 info;
      /// compute:
      checkCudaErrors(cusolverDnSgesvd(cusolverH, jobv, jobu, N, M, Mij, ldA, (cytnx_float *)S->Mem,

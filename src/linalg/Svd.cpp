...
namespace cytnx {
  namespace linalg {
    ...
    static void Svd_Block_UT_internal(std::vector<cytnx::UniTensor> &outCyT,
                                      const cytnx::UniTensor &Tin, const bool &compute_uv) {
    ...
    }  // Svd_Block_UT_internal

    static void Svd_BlockFermionic_UT_internal(std::vector<cytnx::UniTensor> &outCyT,
    ...
    }  // Svd_BlockFermionic_UT_internal
    ...
    std::vector<cytnx::UniTensor> Svd(const cytnx::UniTensor &Tin, const bool &is_UvT) {
      ...
      if (Tin.uten_type() == UTenType.Dense) {
        ...
        Svd_Block_UT_internal(outCyT, Tin, is_UvT);

      } else if (Tin.uten_type() == UTenType.BlockFermionic) {
        Svd_BlockFermionic_UT_internal(outCyT, Tin, is_UvT);

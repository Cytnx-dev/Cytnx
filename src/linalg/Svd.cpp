...
namespace cytnx {
  namespace linalg {
    ...
    namespace {  // actual implementations:
      ...
      void Svd_Block_UT_internal(std::vector<cytnx::UniTensor> &outCyT, const cytnx::UniTensor &Tin,
                                 const bool &compute_uv) {
      ...
      void Svd_BlockFermionic_UT_internal(std::vector<cytnx::UniTensor> &outCyT,

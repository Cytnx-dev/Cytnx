...
namespace cytnx {
  ...
  void cytnx::Symmetry_base::print_info(std::ostream &file) const {
    cytnx_error_msg(true, "%s", "[ERROR][Internal] should not call Symmerty base!");
  }
  ...
  void cytnx::U1Symmetry::print_info(std::ostream &file) const {
    file << "--------------------\n";
    file << "[Symmetry]" << std::endl;
    file << "type : Abelian, U1" << std::endl;
    file << "combine rule : Q1 + Q2" << std::endl;
    file << "reverse rule : Q*(-1) " << std::endl;
    file << "--------------------\n";
  }
  ...
  void cytnx::ZnSymmetry::print_info(std::ostream &file) const {
    file << "--------------------\n";
    file << "[Symmetry]" << std::endl;
    file << "type : Abelian, Z(" << this->n << ")" << std::endl;
    file << "combine rule : (Q1 + Q2)\%" << this->n << std::endl;
    file << "reverse rule : Q*(-1) " << std::endl;
    file << "--------------------\n";
  }
  ...
  void cytnx::FermionParitySymmetry::print_info(std::ostream &file) const {
    file << "--------------------\n";
    file << "[Symmetry]" << std::endl;
    file << "type : fermionic, FermionParity" << std::endl;
    file << "combine rule : (Q1 + Q2)\2" << std::endl;
    file << "reverse rule : Q*(-1) " << std::endl;
    file << "--------------------\n";
  }
  ...
  void cytnx::FermionNumberSymmetry::print_info(std::ostream &file) const {
    file << "--------------------\n";
    file << "[Symmetry]" << std::endl;
    file << "type : fermionic, FermionNumber" << std::endl;
    file << "combine rule : Q1 + Q2" << std::endl;
    file << "reverse rule : Q*(-1) " << std::endl;
    file << "--------------------\n";
  }
  ...
  std::ostream &operator<<(std::ostream &file, const Symmetry &in) {
    in.print_info(file);
    return file;
  }
};  // namespace cytnx
